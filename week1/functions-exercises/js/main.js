...
const tellFortune = function( numberOfChildren, partnersName, location, jobTitle ){
  return `You will be a ${jobTitle} in ${location}, married to ${partnersName} with ${numberOfChildren} kids.`;
};
...
const calculateDogAge = function( dogAge, conversionRate ){
  const humanAge = dogAge * conversionRate;
  return `Your doggie is ${humanAge} years old in human years.`;
};

const myDogsHumanAge = calculateDogAge( 1, 7 );
console.log('When my dog is 1 year old: ', myDogsHumanAge);
const myDogsHumanAgeAt5 = calculateDogAge( 5, 10 );
console.log('When my dog is 5 year old: ', myDogsHumanAgeAt5);
